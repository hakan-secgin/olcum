...
const DEFAULT_HEIGHT_CM = 150; // Ortalama tutuş yüksekliği
...
const App: React.FC = () => {
  ...
  const handleNextStep = () => {
    ...
    if (!hasPermission) {
      requestPermission().then(() => {
        // Skip separate calibration screen, go straight to aiming with default height
  ...
  return (
    <div className="relative w-full h-screen bg-black overflow-hidden select-none">
      ...
      {/* UI Overlay Layer */}
      <Controls 
        step={hasPermission && step === AppStep.PERMISSION ? AppStep.AIM_POINT_1 : step}
